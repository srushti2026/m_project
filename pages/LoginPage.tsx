  ...
  return (
    <div className="flex items-center justify-center py-12">
      <Card className="w-full max-w-md">
        <h2 className="text-3xl font-bold text-center text-slate-900 dark:text-white mb-6">Login to VeilForge</h2>
        <form className="space-y-6" onSubmit={handleLogin}>
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm">
              <button onClick={(e) => { e.preventDefault(); }} className="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500">
        ...
        <p className="mt-6 text-center text-sm text-slate-600 dark:text-gray-400">
          Not a member?{' '}
          <button onClick={() => navigateTo('register')} className="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500">
            Create an account
          </button>
        </p>
      </Card>
